...
def make_clifford_group(num_qubits, implementation):
...
def get_clifford_1q_xypm_implementation(idx):
...
def get_clifford_1q_xzpm2_implementation(idx):
    """Return an implementation of the 1-qubit Clifford group element with the given
...
def get_clifford_2q_implementation(idx, clifford_1q_impl, entangling_gates_impl):
...
def get_cz_entangling_gate_implementation(kind: EntanglingGate, clifford_1q_impl_0):
