...
def make_2q_xy_pi_2_cphase_spec():
    ...
    prep = [[], [ix], [iy], [ix, ix], [xi], [xi, ix], [xi, iy], [xi, ix, ix], [yi],
            [yi, ix], [yi, iy], [yi, ix, ix], [xi, xi], [xi, xi, ix], [xi, xi, iy],
            [xi, xi, ix, ix]]

    meas = [[], [ix], [iy], [ix, ix], [xi], [yi], [xi, xi], [xi, ix], [xi, iy],
            [yi, ix], [yi, iy]]

    germs = [[xi], [yi], [ix], [iy], [cz], [xi, yi], [ix, iy], [iy, yi], [ix, xi],
             ...
             [cz, ix, cz, iy], [ix, xi, yi, cz], [iy, yi, xi, xi, iy],
             [xi, xi, iy, yi, iy], [iy, ix, xi, ix, xi], [yi, iy, yi, ix, ix],
             [iy, xi, ix, iy, yi], [iy, iy, xi, yi, xi], [ix, yi, ix, ix, cz],
             [xi, ix, iy, xi, iy, yi], [xi, iy, ix, yi, ix,
                                        ix], [cz, ix, yi, cz, iy, xi],
             [xi, xi, yi, xi, yi, yi], [ix, ix, iy, ix, iy,
                                        iy], [yi, xi, ix, iy, xi, ix],
             [yi, xi, ix, xi, ix, iy], [xi, ix, iy, iy, xi,
                                        yi], [ix, iy, iy, ix, xi, xi],
             [yi, iy, xi, iy, iy, iy], [yi, yi, yi, iy, yi, ix],
             [iy, iy, xi, iy, ix, iy], [iy, ix, yi, yi, ix, xi, iy],
             [yi, xi, iy, xi, ix, xi, yi, iy], [ix, ix, yi, xi, iy, xi, iy, yi]]

    def flatten(gs):
        return [list(chain.from_iterable(g)) for g in gs]
